    ...
    <div class="col-md-10 ">
      <div class="panel ">
        <div class="panel-heading" style="font-size:18px">
          <b>Final Test Station 1</b>
        <hr/>

     
          <div class="row">
            <div class="col-md-12">
              {!! Form::model(Request::all(),['route'=>'estaciones.finalTestStation1.index', 'method'=>'GET', 'class'=>'form-group','role'=>'search'])!!}
              <div class="row">
                 <div class="col-md-1">
...
{!!Form::open(['route' => ['estaciones.finalTestStation1.destroy',':SERIAL_ID'],'method' => 'DELETE', 'id'=>'form-eliminar'])!!}
{!!Form::close()!!}
@endsection